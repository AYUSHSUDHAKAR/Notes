...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn = findViewById(R.id.activity_registerbtn);
        ...
        boolean isValid;
            ...
            if(!TextUtils.isEmpty(email)){
                if(!TextUtils.isEmpty(password)){
                    ...
                    utilService.showSnackBar(v,"please enter password...");
                    isValid = false;
                }
            }else {
                utilService.showSnackBar(v,"please enter email...");
                isValid = false;
            }
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        String apiKey = "https://notesandroid.herokuapp.com/api/notes/auth/login";
